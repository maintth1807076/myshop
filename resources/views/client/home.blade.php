...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="text-center  text-uppercase col-12 col-sm-auto ">
                <h1 > <pre> X u  h ư ớ n g  m u a  h à n g</pre> </h1>
                <hr>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card mb-2">
                                            ...
                                            <div class="fuild">
                                                <div class="img-cart">
                                                    <a target="_blank" href="/product/{{$list_product_hot[$i]->id}}">
                                                        <div style="  width: 100%; height: 300px;  background-size: cover; background-image:url('{{$list_product_hot[$i]->productDetail->first()->thumbnail}}')"></div>
                                                    </a>
                                    ...
                                    <div class="col-sm-4 clearfix d-none d-md-block">
                                        <div class="card mb-2">
                                            <div class="fuild">
                                                <div class="img-cart">
                                                    <a target="_blank" href="/product/{{$list_product_hot[ $i + 1]->id}}">
                                                        <div style="  width: 100%; height: 300px;  background-size: cover; background-image:url('{{$list_product_hot[$i + 1]->productDetail->first()->thumbnail}}')"></div>
                                                    </a>
                                    ...
                                    <div class="col-sm-4 clearfix d-none d-md-block">
                                        <div class="card mb-2">
                                            <div class="fuild">
                                                <div class="img-cart">
                                                    <a target="_blank" href="/product/{{$list_product_hot[ $i + 2]->id}}">
                                                        <div style="  width: 100%; height: 300px;  background-size: cover; background-image:url('{{$list_product_hot[$i + 2]->productDetail->first()->thumbnail}}')"></div>
                                                    </a>
