                ...
                <div class="contact-content">
                    ...
                    <form accept-charset='UTF-8' action='/contact' class='contact-form' method='post'>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control dark" type="text" id="ContactFormAddress" name="contact[address]"
                                           placeholder="Địa chỉ" value="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input class="form-control dark" type="tel" id="ContactFormPhone" name="contact[phone]"
